...
YATIRIM_SABITI_GES_TL_PER_KWP = 23000
...
def hesapla(v: dict) -> dict:
    ...
    # Öz tüketim hedefi: gündüz oranına göre 0.45–0.85
    oz_tuketim_hedefi = 0.45 + 0.004 * v["gunduz_calisma_orani"]
    ...
    # GES: PV × 23000 × çatı uygunluk çarpanı
    cati_carpani = CATI_UYGUNLUK_CARPANI[v["cati_uygunlugu"]]
    yatirim_ges = pv_kwp * YATIRIM_SABITI_GES_TL_PER_KWP * cati_carpani
